...
const About = () => {
  return (
    <div>
      {/* <div
        className='flex items-center pt-10 justify-center text-richblack-200 bg-richblack-700
'
      >
        <div
...
'
  ...
  w-11/12 max-w-maxContext justify-between gap-10 text-center text-white'
      ...
      <section className='border-b border-richblack-700'>
        <div className='w-11/12 flex flex-col max-w-maxContent gap-10 mx-auto justify-between'>
