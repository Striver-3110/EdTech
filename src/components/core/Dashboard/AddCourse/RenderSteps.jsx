...
const RenderSteps = () => {
  ...
  // useEffect(()=>{
  //   const currStep =  parseInt(JSON.parse(localStorage.getItem('step')));
  //   if(currStep){
  //     dispatch(setStep(currStep));
  //   }
  // },[dispatch]);
  ...
  //   //!red alert
  //   //? as step is number 
  //   //? don't set it to the local storage by converting it to string    
  ...
  return (
    <>
      ...
      <div className='text-white'>kjndfdkjnekjfkjwje</div>
      hbsdjfb */}
